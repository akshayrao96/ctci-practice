...
public class Heap {
  ...
  public static void insertVal(List<Integer> sampleHeap, PriorityQueue<Integer> correct,
      BuildHeap h) {
    insert(1, sampleHeap);
    correct.add(1);
    h.insert(1);
  ...
  public static void printLists(List<Integer> sampleHeap, PriorityQueue<Integer> correct,
      BuildHeap h) {
